...
plt.tight_layout()
plt.savefig("output/figures/webex_review_count_over_time.png")
plt.close()
...
plt.ylabel("Count")
plt.tight_layout()
plt.savefig("output/figures/webex_rating_distribution.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figures/webex_top_emojis.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figures/webex_word_cloud.png")
plt.close()
