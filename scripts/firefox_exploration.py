...
plt.tight_layout()
plt.savefig("output/figures/firefox_review_count_over_time.png")
plt.close()
...
plt.ylabel("Count")
plt.tight_layout()
plt.savefig("output/figures/firefox_rating_distribution.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figures/firefox_top_emojis.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figures/firefox_word_cloud.png")
plt.close()

print("✅ Exploration visualizations saved for Firefox.")
